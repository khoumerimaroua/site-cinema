...
// Ajouter un événement keypress à l'élément input
movieTitleInput.addEventListener("keypress", (event) => {
  if (event.keyCode === 13) { // Si la touche Entrée est pressée
    searchMovies(); // Lancer la fonction de recherche
  }
});

// Modifier l'événement click du bouton de recherche pour appeler la fonction de recherche
// const searchButton = document.getElementById("searchButton");
